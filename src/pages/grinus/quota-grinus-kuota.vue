Sekarang kamu ingin membuat versi yang sama untuk "Manajemen Kuota Griya Nusantara". Berikut adalah kodenya:
...
<template>
  <div class="container mx-auto p-4">
    ...
    <div class="flex justify-between items-center mb-6">
      <h1 class="text-2xl font-bold text-black">Manajemen Kuota Griya Nusantara</h1>
...
const quotas = ref([
  {
    ...
    year: 2025,
    endDate: '2025-07-28',
    totalQuota: 1200000000,
    utilizationPercentage: 4.25,
    mitraCount: 0,
    mitra: []
  },
  {
    ...
    year: 2024,
    endDate: '2025-07-28',
    totalQuota: 800000000000,
    utilizationPercentage: 6.50,
    mitraCount: 2,
    mitra: [
      {
        id: 1,
        name: 'Bank Griya Sejahtera',
        quota: 1500000000,
        utilization: 30.00
      },
      {
        id: 2,
        name: 'Bank Rumah Indonesia',
        quota: 1000000000,
        utilization: 25.00
      }
    ]
...
const quotaFormTitle = computed(() => {
  return editedIndex.value === -1 ? 'Tambah Kuota Induk Griya Nusantara' : 'Edit Kuota Induk Griya Nusantara'
})
...
//   router.push(`/activity-log/view-kuota-mitra-gn/${quota.id}`)
// }

function viewMitraList(quota: any) {
  // router.push(`/activity-log/view-kuota-mitra/${quota.id}`)
  console.log('Viewing mitra list for quota:', quota)
  router.push({ name: 'activity-log-view-kuota-mitra-gn-id', params: { id: quota.id } })
...
function viewMitraDetail(mitraId: number) {
  router.push(`/activity-log/view-kuota-mitra-gn/${mitraId}`)
}
