Sekarang kamu ingin membuat versi yang sama untuk "Permohonan Pengajuan Kuota Griya Nusantara". Berikut adalah kodenya:
    ...
    <VCard class="rounded-lg">
      <VCardItem>
        <VCardTitle class="text-2xl font-bold">
          Permohonan Pengajuan Kuota Griya Nusantara
        </VCardTitle>
      </VCardItem>
  ...
  data() {
    return {
      mitraOptions: [
        ...
        { text: 'Bank Griya Sejahtera', value: 'bank-griya-sejahtera' },
        { text: 'Bank Rumah Indonesia', value: 'bank-rumah-indonesia' },
        { text: 'Bank Perumahan Nasional', value: 'bank-perumahan-nasional' },
        { text: 'Bank Syariah Perumahan', value: 'bank-syariah-perumahan' },
      ],
      formData: {
        namaMitra: '',
        tanggalPermohonan: '',
