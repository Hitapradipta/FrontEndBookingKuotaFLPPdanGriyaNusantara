Sekarang kamu ingin membuat versi yang sama untuk "Status Pengajuan Kuota Griya Nusantara". Berikut adalah kodenya:
...
<template>
  <div class="container mx-auto p-4">
    ...
    <div class="flex justify-between items-center mb-6">
      <h1 class="text-2xl font-bold text-black">Status Pengajuan Kuota Griya Nusantara</h1>
...
const submittedData = ref<any[]>([
  {
    id: 1,
    logActivity: [
      { startDate: '2024-01-15 10:00:00', endDate: '2024-01-15 10:05:00', status: 'Dalam Pengajuan', user: 'Bank Griya Sejahtera', comment: '' },
      { startDate: '2024-01-15 10:05:00', endDate: '2024-01-15 10:10:00', status: 'Sedang di Proses', user: 'Admin Griya', comment: '' },
      { startDate: '2024-01-15 10:10:00', endDate: '2024-01-15 10:15:00', status: 'Disetujui', user: 'Approver Griya', comment: '' }
    ],
    namaMitra: 'Bank Griya Sejahtera',
    tanggalPermohonan: '2024-01-15',
    nominalPorsi100: 1500000000,
    nominalPorsi25: 375000000,
    status: 'Disetujui',
    uploadedFile: {
      name: 'surat_pengajuan_gn_001.pdf',
      url: '/files/surat_pengajuan_gn_001.pdf'
    }
  },
  {
    id: 2,
    logActivity: [
      { startDate: '2024-01-14 09:00:00', endDate: '2024-01-14 09:05:00', status: 'Ditolak', user: 'Bank Rumah Indonesia', comment: 'Dokumen tidak lengkap' }
    ],
    ...
    status: 'Pending',
    uploadedFile: {
      name: 'surat_pengajuan_gn_002.pdf',
      url: '/files/surat_pengajuan_gn_002.pdf'
    }
  },
  {
    id: 3,
