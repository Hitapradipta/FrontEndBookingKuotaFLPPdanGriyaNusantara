...
<template>
  <div class="container mx-auto p-4">
    ...
    <div class="flex justify-between items-center mb-6">
      <h1 class="text-2xl font-bold text-black">Jadwal Angsuran Griya Nusantara</h1>
...
const submittedData = ref([
  {
    id: 1,
    namaMitra: 'Bank Mandiri Griya',
    batch: 'Batch GN-001',
    fileUrl: '/file/gn_manual.pdf',
    fileName: 'gn_manual.pdf',
    status: 'Approved'
  },
  {
    id: 2,
    namaMitra: 'Bank BRI Syariah',
    batch: 'Batch GN-002',
    fileUrl: '/file/gn_jadwal_q1.pdf',
    fileName: 'gn_jadwal_q1.pdf',
    status: 'In Review'
  },
  {
    id: 3,
    namaMitra: 'Bank BNI Cabang Jakarta',
    batch: 'Batch GN-003',
    fileUrl: '/file/gn_angsuran_bulanan.pdf',
    fileName: 'gn_angsuran_bulanan.pdf',
    status: 'Rejected'
  },
])
...
const formTitle = computed(() => {
  return editedIndex.value === -1 ? 'Tambah Data Jadwal Angsuran Griya Nusantara' : 'Edit Data Jadwal Angsuran Griya Nusantara'
})
