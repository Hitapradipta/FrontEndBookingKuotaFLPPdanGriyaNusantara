...
declare global {
  ...
  const decryptMessage: typeof import('./src/utils/security')['decryptMessage']
  ...
  const encryptMessage: typeof import('./src/utils/security')['encryptMessage']
  ...
  const useConfirtableralog: typeof import('@vueuse/core')['useConfirtableralog']
...
declare module 'vue' {
  interface ComponentCustomProperties {
    ...
    readonly decryptMessage: UnwrapRef<typeof import('./src/utils/security')['decryptMessage']>
    ...
    readonly encryptMessage: UnwrapRef<typeof import('./src/utils/security')['encryptMessage']>
